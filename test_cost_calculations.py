...
def test_cost_calculations():
    ...
    scenario = {
        ...
        'cpu_usage_cores': [
            5.5, 5.6, 5.55, 5.58, 5.62, 5.60, 5.59, 5.61,
            5.58, 5.57, 5.59, 5.61, 5.60, 5.58, 5.59, 5.60,
            5.61, 5.59, 5.58, 5.60, 5.61, 5.59, 5.60, 5.58
        ],
        # Power consumption increases with CPU load
        'power_watts': [
            135.5, 136.2, 135.8, 136.0, 136.5, 136.1, 135.9, 136.3,
            136.0, 135.8, 136.1, 136.4, 136.2, 136.0, 136.1, 136.2,
            136.3, 136.1, 136.0, 136.2, 136.3, 136.1, 136.2, 136.0
        ],
        'step_seconds': 5
    }
