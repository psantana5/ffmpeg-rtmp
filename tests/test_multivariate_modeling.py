...
class TestMultivariatePredictor:
    ...
    def test_initialization_custom_params(self):
        ...
        predictor = MultivariatePredictor(
            models=['linear', 'rf'], confidence_level=0.90, n_bootstrap=50, cv_folds=3
        )
    ...
    def test_fit_insufficient_data(self):
        ...
        predictor = MultivariatePredictor()
        scenarios = [
            {'name': '2 Streams @ 2500k', 'bitrate': '2500k', 'power': {'mean_watts': 80.0}}
        ]
    ...
    def test_hardware_id_tracking(self, sample_scenarios):
        ...
        predictor = MultivariatePredictor()
        predictor.fit(sample_scenarios, target='mean_power_watts', hardware_id='Intel_i7_9700K')
