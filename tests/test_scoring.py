...
class TestEnergyEfficiencyScorer:
    ...
    def test_compute_score_single_stream(self):
        ...
        scenario = {'name': '1 Mbps Stream', 'bitrate': '1000k', 'power': {'mean_watts': 50.0}}
    ...
    def test_compute_score_multi_stream(self):
        ...
        scenario = {'name': '4 streams @ 2500k', 'bitrate': '2500k', 'power': {'mean_watts': 100.0}}
    ...
    def test_compute_score_baseline_scenario(self):
        ...
        scenario = {'name': 'Baseline (Idle)', 'bitrate': '0k', 'power': {'mean_watts': 30.0}}
    ...
    def test_compute_score_missing_power(self):
        ...
        scenario = {'name': 'Test Stream', 'bitrate': '2500k'}
    ...
    def test_compute_score_zero_power(self):
        ...
        scenario = {'name': 'Test Stream', 'bitrate': '2500k', 'power': {'mean_watts': 0.0}}
...
class TestQoEScoringAlgorithms:
    ...
    def test_quality_per_watt_scoring(self):
        ...
        scenario = {'name': 'QoE Test', 'vmaf_score': 85.0, 'power': {'mean_watts': 100.0}}
    ...
    def test_quality_per_watt_missing_vmaf(self):
        ...
        scenario = {'name': 'No VMAF Test', 'power': {'mean_watts': 100.0}}
