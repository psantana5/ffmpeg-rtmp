...
class TestOutputLadderScoring:
    ...
    def test_get_output_ladder_single_resolution(self):
        ...
        scenario = {'name': 'Single 720p stream', 'resolution': '1280x720', 'fps': 30}
    ...
    def test_compute_total_pixels_no_duration(self):
        ...
        scenario = {'name': 'No duration', 'resolution': '1280x720', 'fps': 30}
    ...
    def test_pixels_per_joule_multi_resolution(self):
        ...
        scenario = {
            ...
            'power': {'total_energy_joules': 15000.0},
        }
    ...
    def ladder_scenarios(self):
        ...
        return [
            ...
            },
            {
                ...
                'fps': 30,
                'duration': 120,
                'power': {'mean_watts': 80.0, 'total_energy_joules': 9600.0},
            },
            {
                ...
                'power': {'mean_watts': 100.0, 'total_energy_joules': 12000.0},
            },
            {
                ...
                'power': {'mean_watts': 150.0, 'total_energy_joules': 18000.0},
            },
        ]
        ...
        scenarios = [
            {
                ...
                'fps': 30,
                'duration': 120,
                'power': {'mean_watts': 50.0, 'total_energy_joules': 6000.0},
            },
            {
