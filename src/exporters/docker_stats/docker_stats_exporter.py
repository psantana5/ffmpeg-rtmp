    ...
    def do_GET(self):
        if self.path == '/metrics':
            try:
                ...
                if engine_stats:
                    output.append(
                        "# HELP docker_engine_cpu_percent CPU percentage used by Docker engine"
                    )
                ...
                if containers:
                    output.append(
                        "# HELP docker_container_cpu_percent CPU percentage used by container"
                    )
                    output.append("# TYPE docker_container_cpu_percent gauge")

                    output.append(
                        "# HELP docker_container_memory_percent Memory percentage used by container"
                    )
